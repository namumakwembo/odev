...
<div class="h-24 z-50 relative container mx-auto px-6 grid grid-cols-3">
    <div x-data="{showMenu: false}" class="flex items-center"><button x-on:click="showMenu = true"><svg
        ...
        <div x-cloak x-show="showMenu" class="fixed inset-0 w-full h-full bg-white z-50 text-yellow-900"
            style="display: none;">
            <div
                ...
                <button x-on:click="showMenu = false" class="absolute top-0 left-0 mt-8 ml-6"><svg
                    ...
                    href="/blog"
                    class="inline-block border-b-4 border-transparent hover:border-yellow-900">Blog</a> <a
                    href="/contact"
                    class="inline-block border-b-4 border-transparent hover:border-yellow-900">Contact</a></div>
    ...
    <div class="flex items-center justify-center"><a href="/"
            class="text-white uppercase font-bold text-2xl tracking-widest">Bartin Tur</a></div>
    <div class="flex items-center justify-end">
        {{-- <a href="/contact"><svg class="w-8 h-8 text-white" fill="none"
